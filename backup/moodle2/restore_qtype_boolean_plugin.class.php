 ...
 */
class restore_qtype_boolean_plugin extends restore_qtype_plugin 
{
    ...
    const base_extra_fields = 'answers|gate_limit|limitgates|freeinverters|answerform|inputmethod';
     ...
     */
    public function process_boolean($data) 
    {
        global $DB;
