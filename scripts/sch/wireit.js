//Backwards compatibility hack for YUI2 via 2in3. See MDL-34741.
YUI().use('yui2-utilities', 'yui2-resize', 'yui2-layout', 'yui2-container', 'yui2-button', 'yui2-tabview', 'yui2-yuiloader', 'yui2-json', function(Y) {
    var YAHOO = Y.YUI2;
    ...
    lang.extend(WireIt.TerminalProxy, util.DDProxy, {
       ...
       onDrag: function(e) {
          ...
          if(this.terminal.container) 
          {
             //this.fakeTerminal.pos = [e.clientX+this.terminal.container.layer.el.scrollLeft, e.clientY+this.terminal.container.layer.el.scrollTop];
    ...
    WireIt.LayerMap = function(layer,options) {
       ...
       this.options.parentEl = options.parentEl;
    ...
    WireIt.WiringEditor = function(options) {
        ...
        //force the adapter to the moodle-friendly one; fixes a bug
        this.adapter = WireIt.WiringEditor.adapters.InlineForm;
    ...
    WireIt.WiringEditor.prototype = {
     ...
     setOptions: function(options) {
        ...
        this.modules = ('modules' in options) ? options.modules : [];
        ...
        this.adapter = ('adapter' in options) ? options.adapter : WireIt.WiringEditor.adapters.JsonRpc;
         
        this.options.languageName = options.languageName || 'anonymousLanguage';
        
        this.options.propertiesFields = ('propertiesFields' in options) ? options.propertiesFields : [
        ...
        this.options.layoutOptions = ('layoutOptions' in options) ? options.layoutOptions : {
            units: [
        ...
        var layerOptions = ('layerOptions' in options) ? options.layerOptions : {};
        ...
        this.options.layerOptions.layerMapOptions = ('layerMapOptions' in options) ? layerOptions.layerMapOptions : { parentEl: 'layerMap' };

         this.options.accordionViewParams = ('accordionViewParams' in options) ? options.accordionViewParams : {
                                                    collapsible: true, 
